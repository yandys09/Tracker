...
return (
  <Link className=" rounded-md border p-2 hover:bg-indigo-100 " href={`/dashboard/orders/${id}`}>
...
return (
  <Link className=" rounded-md border p-2 hover:bg-indigo-100 " href={`/dashboard/tracking?trackingNumber=${id}`}>
