  ...
  return (
    <div className="bg-indigo-500 w-full flex flex-col h-screen py-2 p-3">
      ...
      >
        ...
        <p
          className={clsx(`text-xl hidden text-indigo-400 font-bold md:block`)}
        >
          Settings
        </p>
      </Link>
      ...
      <div className="cursor-pointer h-16 flex items-center gap-3  ">
        <Image
          ...
          src={`https://images.unsplash.com/photo-1497316730643-415fac54a2af?q=80&w=1064&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`}
        />
        <p
